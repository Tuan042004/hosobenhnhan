...
public class Phong extends javax.swing.JDialog {
    ...
    private void themmoiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_themmoiActionPerformed
        ...
        themphongbenh them = new themphongbenh();
 ...
 private void ReadExcel(String tenFilepath){
    ...
    private void timkiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_timkiemActionPerformed
        ...
        // Kiểm tra xem mã phòng có được nhập không
        if (maPhong.isEmpty()) {
        ...
        try {
            ...
            String checkMaPhongSQL = "SELECT * FROM PhongBenh WHERE MaPhong = ?";
            ...
            if (rs.next()) {
                // Nếu tìm thấy, hiển thị thông tin phòng
                map.setText(rs.getString("MaPhong"));
                tenk.setSelectedItem(rs.getString("TenKhoa"));
                loaip.setText(rs.getString("LoaiPhong"));
                soGiuong.setText(rs.getString("SoGiuong"));
                ttp.setText(rs.getString("TrangThai"));
            } else {
                // Nếu không tìm thấy, hiển thị thông báo mã phòng không tồn tại
    ...
    private void Themphongbenh(String map, String tk, String lp, String sg, String tt) {
