...
public class themgiuong extends javax.swing.JFrame {
    ...
    try {
        ...
        // Truy vấn để lấy danh sách mã phòng cho mã giường đã cho
    ...
    private void xoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_xoaActionPerformed
        // Giả sử bạn có các combo box mã phòng và mã giường trong form chính
        String map = ma_p.getSelectedItem().toString();  // Lấy giá trị được chọn từ comboBox mã phòng
