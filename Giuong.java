...
public class Giuong extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(tk_mp, javax.swing.GroupLayout.PREFERRED_SIZE, 136, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(30, 30, 30)
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(map, javax.swing.GroupLayout.PREFERRED_SIZE, 183, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel4Layout.createSequentialGroup()
    ...
    private void themmoiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_themmoiActionPerformed
        ...
        themGiuongbenh themg = new themGiuongbenh();
    ...
    private void xuatexActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_xuatexActionPerformed
        ...
        try {
            ...
            con = QuanLyBenhNhan.conDB.ketnoidb(); // Đảm bảo kết nối không null
            if (con == null) {
    ...
    private void timkiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_timkiemActionPerformed
      ...
      // Kiểm tra xem mã giường và mã phòng có được nhập không
      if (maGiuong.isEmpty() && maPhong.isEmpty()) {
          JOptionPane.showMessageDialog(this, "Vui lòng nhập mã giường và mã phòng!", "Cảnh báo", JOptionPane.WARNING_MESSAGE);
          return;
      } else if (maGiuong.isEmpty()) {
      ...
      try {
          con = QuanLyBenhNhan.conDB.ketnoidb(); // Kết nối cơ sở dữ liệu

          // Kiểm tra mã giường có tồn tại hay không
          String checkMaGiuongSQL = "SELECT COUNT(*) FROM Giuong WHERE MaGiuong = ?";
          pst = con.prepareStatement(checkMaGiuongSQL);
          pst.setString(1, maGiuong);
          rs = pst.executeQuery();
          rs.next();
          int countMaGiuong = rs.getInt(1);
          if (countMaGiuong == 0) {
              JOptionPane.showMessageDialog(this, "Mã giường không tồn tại!", "Lỗi", JOptionPane.ERROR_MESSAGE);
              return;
          }

          // Kiểm tra mã phòng có tồn tại hay không
          String checkMaPhongSQL = "SELECT COUNT(*) FROM PhongBenh WHERE MaPhong = ?";
          pst = con.prepareStatement(checkMaPhongSQL);
          pst.setString(1, maPhong);
          rs = pst.executeQuery();
          rs.next();
          int countMaPhong = rs.getInt(1);
          if (countMaPhong == 0) {
              JOptionPane.showMessageDialog(this, "Mã phòng không tồn tại!", "Lỗi", JOptionPane.ERROR_MESSAGE);
              return;
          }

          // Nếu cả mã giường và mã phòng đều tồn tại, tiếp tục tìm giường theo mã giường và mã phòng
          String sql = "SELECT * FROM Giuong WHERE MaGiuong = ? AND MaPhong = ?";
          ...
          if (rs.next()) {
              // Nếu tìm thấy, hiển thị thông tin giường
              ma_g.setText(rs.getString("MaGiuong"));

              // Hiển thị mã phòng trong JComboBox
              String maPhongFromDB = rs.getString("MaPhong");
              if (maPhongFromDB != null) {
                  // Kiểm tra nếu mã phòng chưa có trong JComboBox thì thêm vào
                  if (((DefaultComboBoxModel) map.getModel()).getIndexOf(maPhongFromDB) == -1) {
                      map.addItem(maPhongFromDB);
                  }
                  // Đặt mã phòng từ cơ sở dữ liệu vào JComboBox
                  map.setSelectedItem(maPhongFromDB);
              } else {
                  JOptionPane.showMessageDialog(this, "Không tìm thấy mã phòng tương ứng!", "Lỗi", JOptionPane.ERROR_MESSAGE);
              }

              tt.setText(rs.getString("TrangThaiGiuong"));
          } else {
              // Nếu không tìm thấy, hiển thị thông báo giường không tồn tại trong phòng đã cho
              JOptionPane.showMessageDialog(this, "Không tìm thấy giường với mã giường và mã phòng đã cho!", "Thông báo", JOptionPane.WARNING_MESSAGE);
          }
      } catch (SQLException e) {
          e.printStackTrace();
    ...
    private void tbGiuongMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbGiuongMouseClicked
        ...
        map.setSelectedItem(mapValue != null ? mapValue.toString() : "");
    ...
    private void tk_mgKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tk_mgKeyReleased
        ...
        String sql = "SELECT * FROM Giuong WHERE MaGiuong LIKE '%" + mxv + "%'";
    ...
    private void tk_mpKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tk_mpKeyReleased
        // TODO add your handling code here:
        try {
           String mp = tk_mp.getText().trim();  // Mã xuất viện

        con = conDB.ketnoidb();
        Statement st = con.createStatement();

        // Xây dựng câu lệnh SQL cho tìm kiếm
        String sql = "SELECT * FROM Giuong WHERE MaPhong LIKE '%" + mp + "%'";
    ...
    private void themg(String map, String tk, String lp) {
